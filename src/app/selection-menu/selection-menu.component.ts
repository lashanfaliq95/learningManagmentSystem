...
export class SelectionMenuComponent implements OnInit {
  ...
  selectionMapping = [
    {
      id: '1', message: 'Show me the courses that I have completed',
      redirectUrl: '/completedCourses'
    },
    {
      id: '2', message: 'Show me the eligible courses that I have to take on this semester',
      redirectUrl: '/eligibleCourses'
    },
    {
      id: '3', message: 'Show me the prerequisites for my degree',
      redirectUrl: '/prerequisiteCourses'
    },
    {
      id: '4', message: 'Map out all semesters',
      redirectUrl: '/semesterMap'
    },
    {
      id: '5', message: 'Show me the courses offered in the current semester only',
      redirectUrl: '/currentSemesterCourses'
    },
    {
      id: '6', message: 'Register me for the coming semester',
